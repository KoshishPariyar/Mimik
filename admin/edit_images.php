...
if (isset($_POST['update_images'])) {
    ...
    if (empty($error_message)) {
        ...
        if ($uploadSuccess) {
            header('location:product.php?update_success=Images updated successfully');
            exit;
        } else {
        ...
        <main class="col-md-9 ms-sm-auto col-lg-9 px-md-4">
            ...
            <div class="table-responsive">
                <div class="mx-auto container">
                    <form id="edit-image-form" enctype="multipart/form-data" method="POST" action="edit_images.php" onsubmit="return validateImageForm()">
