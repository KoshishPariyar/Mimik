...
// if user is logged in
    ...
    if(!$stmt_status){
        ...
        // 2 issue new order and store order info in datbase
    ...
    //4.store each single item in order_items database
        ...
        //5.remove evrything from cart--> delay auntil payment is done 
        ...
        header('location:../payment.php?order_status=oder placed successfully');
