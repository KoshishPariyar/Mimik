...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['place_order'])) {
    ...
    if (empty($error_message)) {
        ...
        if ($stmt->execute()) {
            header('location:order_success.php?message=Order placed successfully');
            exit();
        } else {
            $error_message = "Could not place order. Try again.";
        }
    }
}
...
<section class="my-5 py-5">
    <div class="container text-center mt-3 pt-5">
        <h2 class="form-weight-bold" style="border-bottom: 3px solid #088178;">Check Out</h2>
    </div>
    <div class="mx-auto-container">
        <form method="POST" id="checkout-form" action="checkout.php" onsubmit="return validateCheckoutForm()">
            ...
            <div class="form-group checkout-small-element">
                ...
                <input type="text" name="name" id="checkout-name" class="form-control" placeholder="Enter your name" required>
            </div>

            <!-- Email -->
            <div class="form-group checkout-small-element">
                <label for="checkout-email">Email</label>
                <input type="text" name="email" id="checkout-email" class="form-control" placeholder="Enter your email" required>
            </div>

            <!-- Phone -->
            <div class="form-group checkout-small-element">
                <label for="checkout-phone">Phone</label>
                <input type="tel" name="phone" id="checkout-phone" class="form-control" placeholder="Enter your phone number" required>
            </div>

            <!-- City -->
            <div class="form-group checkout-small-element">
                <label for="checkout-city">City</label>
                <input type="text" name="city" id="checkout-city" class="form-control" placeholder="Enter your city" required>
            </div>

            <!-- Address -->
            <div class="form-group checkout-large-element">
                <label for="checkout-address">Address</label>
                <input type="text" name="address" id="checkout-address" class="form-control" placeholder="Enter your address" required>
            </div>
