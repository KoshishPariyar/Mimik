...
<?php include('layouts/header.php');?>
      ...
      <section class="my-5 py-5">
        <div class="row container mx-auto">
            ...
            <p class="text-center" style="color:#088178"><?php if(isset($_GET['register_success'])){echo $_GET['register_success'];}?></p>
            <p class="text-center" style="color:#088178"><?php if(isset($_GET['login_success'])){echo $_GET['login_success'];}?></p>
            ...
            <div class="col-lg-6 col-md-12 c0l-sm-12">
                <form action="account.php"id="account-form" method="POST">
                    ...
                    <p class="text-center" style="color:#088178"><?php if(isset($_GET['message'])){echo $_GET['message'];}?></p>
...
<!-- Orders -->
    <section id="orders" class="container my-5 py-5">
        <div class="container mt-2">
            <h2 class="font-weight-bold text-center" style="border-bottom: 3px solid #088178; ">Your Orders</h2>
        </div>
